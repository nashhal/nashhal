(()=>{
  ...
  const load=src=>new Promise((ok,no)=>{const s=document.createElement('script');s.src=`${src}?v=20260914-23`;s.onload=ok;s.onerror=no;document.head.appendChild(s)});
